...
#include <sys/socket.h> //for socket(), connect(), bind(), send(), recv()

#define buffserSize 128
#define MAXPENDING 5
...
static command commands[] = {
  {nullTerminatedCmd, "Sent as a null-terminated string", "Null Terminated: "},
  {givenLengthCmd, "Sent as an unterminated string", "Given Length: "},
  {badIntCmd, "20160919", "Bad Int: "},
  {goodIntCmd, "20160919", "Good Int: "},
  {byteAtATimeCmd, "500000", "Byte At A Time: "},
  {kByteAtATimeCmd, "500000", "KByte At A Time: "},
  {noMoreCommands, "", ""}
};
